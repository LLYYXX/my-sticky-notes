...
def main() -> int:
    with tempfile.TemporaryDirectory() as directory:
        ...
        controller.settings_window._default_color.set("yellow")
        controller.settings_window._commit()
        assert controller.state.settings.default_color == "yellow"
        controller.settings_window._default_color.set("offwhite")
        controller.settings_window._commit()
        ...
        assert restored.settings.new_notes_pinned is True
        controller.stop()
