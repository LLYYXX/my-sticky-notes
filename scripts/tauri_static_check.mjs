...
const checks = [
  ...
  ["note chrome uses icon assets instead of text glyph controls", app.includes('src="./icons/${name}.svg"') && styles.includes("filter: var(--note-icon-filter") && !app.includes(">＋</button>") && !app.includes(">⌾</button>")],
